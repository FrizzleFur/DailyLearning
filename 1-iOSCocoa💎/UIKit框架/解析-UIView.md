...
* UIView 动画在执行过程中布局subview的动画
    * layoutSubviews during an animation?
    * [iphone - layoutSubviews during an animation? - Stack Overflow](https://stackoverflow.com/questions/3693539/layoutsubviews-during-an-animation)
