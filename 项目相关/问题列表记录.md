...
用户设置
                /* 注销成功，退出 */
                [PushMangerInstance gotoLogout:^{
                    [PushMangerInstance resetNavigationControllerWithIndex:TabBarIndex_Home];
...
* [ ] `cut2DecimalFloatByFloat`改成`reviseFloatString`---可以实现吗？
* [ ] 优化-小数点浮动数字
